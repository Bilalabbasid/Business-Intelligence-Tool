...
class PIICategory(BaseModel):
    ...
    def get_regulatory_requirements(self):
        """Parse regulatory requirements JSON."""
        try:
            return json.loads(self.regulatory_requirements)
        except (json.JSONDecodeError, TypeError):
            return []
    
    def set_regulatory_requirements(self, data):
        """Set regulatory requirements as JSON string."""
        self.regulatory_requirements = json.dumps(data) if data else '[]'
...
class DataSubject(BaseModel):
    ...
    # Metadata
    data_sources = models.TextField(default='[]')  # JSON as text field
    processing_purposes = models.TextField(default='[]')  # JSON as text field
    legal_basis = models.TextField(default='{}')  # JSON as text field
    metadata = models.TextField(default='{}')  # JSON as text field
    ...
    def set_data_sources(self, data):
        """Set data sources as JSON string."""
        self.data_sources = json.dumps(data) if data else '[]'
...
class DataSubjectRequest(BaseModel):
    ...
    specific_data_requested = models.TextField(default='[]')  # JSON as text field
    ...
    response_data = models.TextField(default='{}')  # JSON as text field
    response_files = models.TextField(default='[]')  # JSON as text field
...
class PIIProcessingRecord(BaseModel):
    ...
    # Data details
    data_categories = models.TextField(default='[]')  # JSON as text field
    data_sources = models.TextField(default='[]')  # JSON as text field
    data_recipients = models.TextField(default='[]')  # JSON as text field
